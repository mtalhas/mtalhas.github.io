...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    startDate: "08/2017",
    endDate: "08/2025",
    summary: "Owned API Management and integration platform delivery across multiple industries, later extending the same foundation into Azure AI services. Built custom gateway solutions, automated testing and CI/CD, and hardened production reliability.",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Directed system administration for Linux environments using advanced shell utilities (sed, awk, grep) and managed MySQL/Oracle SQL databases, sustaining high availability across Production and Lower environments",
